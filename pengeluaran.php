...
function hitungTotalPengeluaran($koneksi) {
    $sql = "SELECT SUM(total) as total_pengeluaran FROM pembelian";
...
// Mengambil total pengeluaran setiap kali halaman diakses
$totalPengeluaran = hitungTotalPengeluaran($koneksi);

// Menutup koneksi (opsional, tergantung pada kebutuhan Anda)
$koneksi->close();

// Menampilkan total pengeluaran
// echo "Total Pengeluaran: Rp " . number_format($totalPengeluaran, 2, ',', '.');
?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Pengeluaran</h4>
    ...
    <table>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='3'>Tidak ada data transaksi pembelian.</td></tr>";
            }
            ?>
        </tbody>
    </table>
    <br>
    Total Pengeluaran: Rp <?php echo number_format($totalPengeluaran, 2, ',', '.'); ?>
