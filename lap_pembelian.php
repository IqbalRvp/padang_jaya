...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Laporan Pembelian</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.php">Home</a></li>
                                <li><span>Laporan Pembelian</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="container mt-5">
        ...
        <?php } else { ?>
            <a href="cetak_semua_pembelian.php" target="_blank" class="btn btn-success mb-3">Cetak Semua</a>
            <table class="table">
                <thead>
                    <tr>
                        <th>ID Pembelian</th>
                ...
                <tbody>
                    <?php foreach($pembelian_data as $pembelian) { ?>
                        <tr>
                            ...
                            <!-- <td>
                                <form action="cetak_pembelian.php" method="post" target="_blank">
                                    <input type="hidden" name="kode_pembelian" value="<?php echo $pembelian['kode_pembelian']; ?>">
