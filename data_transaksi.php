...
// Query untuk mengambil data transaksi pembelian
$query_pembelian = "SELECT kode_pembelian AS id, id_barang, jumlah, harga_beli AS harga, total, tanggal, 'Pembelian' AS jenis_transaksi FROM pembelian";

// Query untuk mengambil data transaksi penjualan
$query_penjualan = "SELECT kode_penjualan AS id, id_barang, jumlah, harga_jual AS harga, total, tanggal, 'Penjualan' AS jenis_transaksi FROM penjualan";

// Gabungkan kedua query dengan UNION
$query_transaksi = "$query_pembelian UNION $query_penjualan ORDER BY tanggal DESC";

// Eksekusi query transaksi
$result_transaksi = mysqli_query($koneksi, $query_transaksi);

// Check jika terjadi kesalahan dalam eksekusi query
if (!$result_transaksi) {
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Data Transaksi</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.php">Home</a></li>
                                <li><span>Data Transaksi</span></li>
                            </ul>
                        </div>
                    </div>
